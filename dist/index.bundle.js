...
const dom = (() => {
  ...
  function populateTabBar() {
    ...
    _projects__WEBPACK_IMPORTED_MODULE_0__["default"].myProjects = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].fetchStoredProjects();

    if (_projects__WEBPACK_IMPORTED_MODULE_0__["default"].myProjects) {
  ...
  function createProjectEditModal(project) {
    ...
    dialog.setAttribute("id", `projectEdit${_projects__WEBPACK_IMPORTED_MODULE_0__["default"].getID(project)}`);
  ...
  function createTodoDiv(project) {
    ...
    if (project != "All") {
      ...
      editBtn.addEventListener("click", () => {
        _handlers__WEBPACK_IMPORTED_MODULE_1__["default"].handleProjectEdit(project);
      });
      ...
      addBtn.addEventListener("click", _handlers__WEBPACK_IMPORTED_MODULE_1__["default"].handleNewTodoClick);
  ...
  function viewTodos(project) {
    ...
    _todos__WEBPACK_IMPORTED_MODULE_2__["default"].myTodos = _todos__WEBPACK_IMPORTED_MODULE_2__["default"].fetchStoredTodos();
    ...
    _todos__WEBPACK_IMPORTED_MODULE_2__["default"].myTodos.forEach((todo) => {
      if (todo.project == project || project == "All") {
        ...
        prio.textContent = `${_todos__WEBPACK_IMPORTED_MODULE_2__["default"].convertPriority(todo.priority)} priority`;
        ...
        if (!todo.active) {
          ...
          deactivate.textContent = "-";
          editBtn.addEventListener("click", () => {
            _handlers__WEBPACK_IMPORTED_MODULE_1__["default"].handleTodoEdit(todo);
          });
          deleteBtn.addEventListener("click", () => {
            _handlers__WEBPACK_IMPORTED_MODULE_1__["default"].handleTodoDelete(todo);
          });
        }
...
const handlers = (() => {
  ...
  function handleNewProjectSubmit() {
    ...
    form.addEventListener("submit", (e) => {
      ...
      if (
        ...
        _projects__WEBPACK_IMPORTED_MODULE_1__["default"].addProject(
          _projects__WEBPACK_IMPORTED_MODULE_1__["default"].createNewProject(
            project.value,
            false,
            _projects__WEBPACK_IMPORTED_MODULE_1__["default"].myProjects.length ? _projects__WEBPACK_IMPORTED_MODULE_1__["default"].myProjects.length : 0
          )
        );
  ...
  function validateProject(newProject, form) {
    ...
    if (_projects__WEBPACK_IMPORTED_MODULE_1__["default"].myProjects) {
          ...
          if (validateTodo(form)) {
            _todos__WEBPACK_IMPORTED_MODULE_2__["default"].addTodo(
              _todos__WEBPACK_IMPORTED_MODULE_2__["default"].createNewTodo(
                ...
                _todos__WEBPACK_IMPORTED_MODULE_2__["default"].convertPriority(form.querySelector(".priority").value),
                form.querySelector(".dueDate").value,
                true,
                _todos__WEBPACK_IMPORTED_MODULE_2__["default"].myTodos.length
              )
            );
  ...
  function validateTodo(form) {
    ...
    let dateValid = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(dateArr[0], dateArr[1], dateArr[2]))
      ? true
      : false;
    ...
    form.addEventListener("submit", (e) => {
      ...
      _projects__WEBPACK_IMPORTED_MODULE_1__["default"].myProjects.forEach((element) => {
        if (element.selected) {
          ...
          if (validateTodo(form)) {
            // console.log("valid");
            _todos__WEBPACK_IMPORTED_MODULE_2__["default"].editTodo(form);
            _dom__WEBPACK_IMPORTED_MODULE_0__["default"].createTodoDiv(element.name);
            form.reset();
  ...
  function handleTodoDelete(todo) {
    ...
    if (confirm("Are you sure? This action cannot be undone.")) {
      _todos__WEBPACK_IMPORTED_MODULE_2__["default"].deleteTodo(todo.id);
      // todos.redoTodoIDs();
      _dom__WEBPACK_IMPORTED_MODULE_0__["default"].createTodoDiv(todo.project);
    }
  }

  function handleTodoDeactivate(todo) {
    todo.active = todo.active ? false : true;
    _localStorage__WEBPACK_IMPORTED_MODULE_3__["default"].editStorageItem(todo);
  }

  function handleProjectEditSubmit(project) {
    const form = document.querySelector(
      `#projectEdit${_projects__WEBPACK_IMPORTED_MODULE_1__["default"].getID(project)}>form`
    );
    form.addEventListener("submit", (e) => {
      let newProject = form.querySelector(".project").value;
      //   console.log("edit");
      _projects__WEBPACK_IMPORTED_MODULE_1__["default"].myProjects = _projects__WEBPACK_IMPORTED_MODULE_1__["default"].getMyProjectsArr();
      //   console.log(projects.myProjects);
      //   console.log(element.id);
      //   console.log(projects.getID(project));
      _projects__WEBPACK_IMPORTED_MODULE_1__["default"].myProjects.forEach((element) => {
        if (
          element.projectID == _projects__WEBPACK_IMPORTED_MODULE_1__["default"].getID(project) &&
          validateProject(newProject, form)
        ) {
          //   console.log(element);
          //   console.log(form);
          //   console.log("valid");
          _projects__WEBPACK_IMPORTED_MODULE_1__["default"].editProject(project, newProject);
          _dom__WEBPACK_IMPORTED_MODULE_0__["default"].populateTabBar();
          _dom__WEBPACK_IMPORTED_MODULE_0__["default"].createTodoDiv(newProject);
          form.reset();
  ...
  function handleProjectEdit(project) {
    const dialog = document.querySelector(
      `#projectEdit${_projects__WEBPACK_IMPORTED_MODULE_1__["default"].getID(project)}`
    );
    // console.log(dialogs);
    dialog.showModal();
    ...
    dialog.querySelector(".delete").addEventListener("click", (e) => {
      ...
      if (
        ...
        _projects__WEBPACK_IMPORTED_MODULE_1__["default"].deleteProject(project);
        _dom__WEBPACK_IMPORTED_MODULE_0__["default"].populateTabBar();
        _dom__WEBPACK_IMPORTED_MODULE_0__["default"].createTodoDiv("All");
        dialog.close();
      }
    });
...
const projects = (() => {
  ...
  function getMyProjectsArr() {
    let myProjects = [];
    if (_localStorage__WEBPACK_IMPORTED_MODULE_0__["default"].retrieveStoredProjects()) {
      myProjects = _localStorage__WEBPACK_IMPORTED_MODULE_0__["default"].retrieveStoredProjects();
    }
    return myProjects;
  }
  ...
  function addProject(project) {
    ...
    // console.log(myProjects);
    // console.log(myProjects);
    _localStorage__WEBPACK_IMPORTED_MODULE_0__["default"].populateStorage(myProjects);
    // console.log(localStorages.retrieveStorage("projects"));
  }
  ...
  function fetchStoredProjects() {
    // myProjects = getMyProjectsArr();
    // console.log(localStorages.retrieveStorage("projects"));
    return _localStorage__WEBPACK_IMPORTED_MODULE_0__["default"].retrieveStorage("projects");
    // return myTodos;
  }
  ...
  function editProject(project, newProject) {
    ...
    _todos__WEBPACK_IMPORTED_MODULE_1__["default"].editTodoProject(project, newProject);
  }
  ...
  function deleteProject(project) {
    ...
    _localStorage__WEBPACK_IMPORTED_MODULE_0__["default"].populateStorage(myProjects);
    _todos__WEBPACK_IMPORTED_MODULE_1__["default"].deleteProjectTodos(project);
  }
...
const todos = (() => {
  ...
  function addTodo(todo) {
    // console.log(todo);
    _localStorage__WEBPACK_IMPORTED_MODULE_0__["default"].populateStorage(todo);
    // pushTodo(todo);
  }
  ...
  function fetchStoredTodos() {
    myTodos = [];
    let counter = 0;
    while (_localStorage__WEBPACK_IMPORTED_MODULE_0__["default"].retrieveStorage(counter)) {
      //   console.log(localStorages.retrieveStorage(counter));
      myTodos.push(_localStorage__WEBPACK_IMPORTED_MODULE_0__["default"].retrieveStorage(counter));
      counter++;
    }
    return myTodos;
  }
  ...
  function editTodo(form) {
    ...
    myTodos.forEach((oldTodo) => {
      if (oldTodo.id == todoID) {
        ...
        // console.log(oldTodo);
        _localStorage__WEBPACK_IMPORTED_MODULE_0__["default"].editStorageItem(oldTodo);
      }
    });
  }
  ...
  function editTodoProject(project, newProject) {
    myTodos.forEach((todo) => {
      if (todo.project == project) {
        ...
        _localStorage__WEBPACK_IMPORTED_MODULE_0__["default"].editStorageItem(todo);
      }
    });
  }
